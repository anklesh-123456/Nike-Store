...
return () =>{
  ...
  return (
    <>
     <header className={
      !navstate ? 'absolute top-7 left-0 right-0 opacity-100 z-50':'fixed top-0 right-0 left-0 h-[9vh] flex items-center justify-center opacity-100 z-[200] blur-effect-theme'}>
